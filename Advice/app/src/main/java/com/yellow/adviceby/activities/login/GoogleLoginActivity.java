...
public class GoogleLoginActivity extends Observable
    ...
    private static StateA currentState;
    private static GoogleLoginActivity sGoogleConnection;

    private static final int RC_SIGN_IN = 0;

    private DBUserHandler dbUserHandler;

    private GoogleLoginActivity(Activity activity) {
        ...
        currentState = StateA.CLOSED;
    }

    private void changeState(StateA state) {
    ...
    public static GoogleLoginActivity getInstance(Activity activity) {
        if (null == sGoogleConnection) {
            sGoogleConnection = new GoogleLoginActivity(activity);
        }
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        if (!currentState.equals(StateA.IN_PROGRESS)) {
        ...
        //    mSignInError = result.getErrorCode();
            ...
            if (currentState.equals(StateA.SIGN_IN)) {
    ...
    private void resolveSignInError() {
        ...
        if (mSignInIntent != null) {
            ...
            try {
                ...
                changeState(StateA.IN_PROGRESS);
